...
{
    static auto fnGetWpnData = (CCSWeaponInfo*(__thiscall*)(void*))(Utils::PatternScan(GetModuleHandleW(L"client.dll"), "55 8B EC 81 EC ? ? ? ? 53 8B D9 56 57 8D 8B"));
