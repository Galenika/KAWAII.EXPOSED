...
#define SEQUENCE_BOWIE_IDLE1 1
	...
	void __stdcall hkPaintTraverse(vgui::VPANEL panel, bool forceRepaint, bool allowForce)
	{
		...
		else if (panelId == panel) 
		{
			...
			if (g_Options.watermarks == true)
			{
				...
				g_VGuiSurface->DrawPrintText(L"KAWAII.EXPOSED", wcslen(L"KAWAII.EXPOSED"));
			}
	...
	void __stdcall hkFrameStageNotify(ClientFrameStage_t stage)
	{
		...
		{			
			...
			if (g_Options.clantag == KAWAII_STATIC)
			{
				Utils::SetClantag("kawaii-$-exposed");
			}
			...
			if (g_Options.clantag == KAWAII_ANIMATED)
			{
				...
				case 27:
					...
					break;
				case 28:
					Utils::SetClantag("kaw        ");
					break;
				case 29:
					Utils::SetClantag("kaw       a");
					break;
				case 30:
					Utils::SetClantag("kaw      a ");
					break;
				...
				case 35:
					...
					break;
				case 36:
					Utils::SetClantag("kawa       ");
					break;
				case 37:
					Utils::SetClantag("kawa      i");
					break;
				case 38:
					Utils::SetClantag("kawa     i ");
					break;
				...
				case 43:
					...
					break;
				case 44:
					Utils::SetClantag("kawai      ");
					break;
				case 45:
					Utils::SetClantag("kawai    i ");
					break;
				case 46:
					Utils::SetClantag("kawai   i  ");
					break;
				...
				case 48:
					...
					break;
				case 49:
					Utils::SetClantag("kawaii     ");
					break;
				case 50:
					Utils::SetClantag("kawaii    o");
					break;
				case 51:
					Utils::SetClantag("kawaii   o ");
					break;
				...
				case 53:
					...
					break;
				case 54:
					Utils::SetClantag("kawaii o  w");
					break;
					Utils::SetClantag("kawaii o w ");
					break;
				case 58:
					Utils::SetClantag("kawaii ow  ");
					break;
				case 59:
					Utils::SetClantag("kawaii ow o");
					break;
				case 60:
					Utils::SetClantag("kawaii owo");
					break;
				case 61:
					Utils::SetClantag("          ");
					break;
				case 62:
					Utils::SetClantag("best  ");
					break;
				case 63:
					Utils::SetClantag("best ");
					break;
				case 64:
					Utils::SetClantag("cheat  ");
					break;
				case 65:
					Utils::SetClantag("cheat  ");
					break;
			...
			if (g_Options.clantag == VALVE)
			{
				...
				case 2:Utils::SetClantag("       se"); break;
				case 3:Utils::SetClantag("      nse"); break;
				case 4:Utils::SetClantag("     ense"); break;
				case 5:Utils::SetClantag("    sense"); break;
				case 6:Utils::SetClantag("   esense"); break;
				case 7:Utils::SetClantag("  mesense"); break;
				case 8:Utils::SetClantag(" amesense"); break;
				case 9:Utils::SetClantag("gamesense"); break;
				case 10:Utils::SetClantag("amesense "); break;
				case 11:Utils::SetClantag("mesense  "); break;
				case 12:Utils::SetClantag("esense   "); break;
				case 13:Utils::SetClantag("sense    "); break;
				case 14:Utils::SetClantag("ense     "); break;
				case 15:Utils::SetClantag("nse      "); break;
				case 16:Utils::SetClantag("se       "); break;
				case 17:Utils::SetClantag("e        "); break;
				}
				counter++;
			}
